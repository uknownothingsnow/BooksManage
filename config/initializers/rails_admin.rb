# RailsAdmin config file. Generated on May 04, 2012 18:54
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Books Manage', 'Admin']
  ...
  # config.included_models = [Book, Tag, User]
  ...
  # config.model Tag do
  #   # Found associations:
  #     configure :books, :has_and_belongs_to_many_association   #   # Found columns:
  #     configure :_type, :text         # Hidden 
  #     configure :_id, :bson_object_id 
  #     configure :name, :string 
  #     configure :code, :integer 
  #     configure :book_ids, :serialized         # Hidden   #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  #   edit do; end
  ...
  #     configure :_type, :text         # Hidden 
  #     configure :_id, :bson_object_id 
  #     configure :book_ids, :serialized         # Hidden 
